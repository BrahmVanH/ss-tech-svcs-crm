...
export type CreateCustomerMutation = { __typename?: 'Mutation', createCustomer: { __typename?: 'Customer', _id: string, createdAt: string, firstName: string, lastName: string, email: string, phone: number, businessName: string } };
...
export type DeleteCustomerMutation = { __typename?: 'Mutation', deleteCustomer: { __typename?: 'Customer', _id: string, firstName: string, lastName: string, email: string, phone: number, businessName: string } };
...
export type QueryCustomerByIdQuery = { __typename?: 'Query', queryCustomerById: { __typename?: 'Customer', _id: string, createdAt: string, firstName: string, lastName: string, email: string, phone: number, businessName: string, workOrders: Array<{ __typename?: 'WorkOrder', _id: string, date: string, type: string, charged: boolean, paid: boolean, propertyId: { __typename?: 'Property', _id: string, propertyName: string, propertyAddress: { __typename?: 'Address', street: string, city: string, state: string, zip: string } } } | null> } };
...
export type QueryWorkOrdersQuery = { __typename?: 'Query', queryWorkOrders?: Array<{ __typename?: 'WorkOrder', _id: string, date: string, lastUpdated: string, type: string, description: string, quote: number, total: number, charged: boolean, paid: boolean, comments: string, customerId: { __typename?: 'Customer', _id: string, firstName: string, lastName: string, email: string, phone: number, businessName: string }, propertyId: { __typename?: 'Property', _id: string, propertyName: string, propertyDescription: string, s3FolderKey: string, propertyAddress: { __typename?: 'Address', street: string, city: string, state: string, zip: string }, agent: { __typename?: 'Customer', _id: string, firstName: string, lastName: string, phone: number } } }> | null };
...
export type QueryInvoicesQuery = { __typename?: 'Query', queryInvoices?: Array<{ __typename?: 'Invoice', _id: string, invoiceNumber: string, date: string, quote: number, total: number, charged: boolean, paid: boolean, customerId: { __typename?: 'Customer', _id: string, firstName: string, lastName: string, email: string, phone: number, businessName: string }, workOrders: Array<{ __typename?: 'WorkOrder', _id: string, date: string, type: string } | null> }> | null };
